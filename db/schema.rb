...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "netino_config", :id => false, :force => true do |t|
    t.integer "mode_nok",  :limit => 1, :default => 0,  :null => false
    t.text    "password",                               :null => false
    t.integer "mode_html", :limit => 1, :default => 0,  :null => false
    t.date    "datemodo",                               :null => false
    t.string  "version",   :limit => 5, :default => "", :null => false
  end

  create_table "netino_ips", :id => false, :force => true do |t|
  ...
  add_index "phpbb_acl_options", ["auth_option"], :name => "auth_option", :unique => true
  ...
  create_table "phpbb_cloud_tag", :primary_key => "tag_id", :force => true do |t|
  ...
  create_table "phpbb_count_votes", :id => false, :force => true do |t|
  ...
  create_table "phpbb_forums", :primary_key => "forum_id", :force => true do |t|
    ...
    t.string  "forum_image",                                  :default => ""
    t.string  "forum_pro_tips_image"
    t.string  "forum_link_to_pro_tips"
  ...
  create_table "phpbb_forums_old", :primary_key => "forum_id", :force => true do |t|
    t.integer "parent_id",                :limit => 3,        :default => 0,     :null => false
    t.integer "left_id",                  :limit => 3,        :default => 0,     :null => false
    t.integer "right_id",                 :limit => 3,        :default => 0,     :null => false
    t.text    "forum_parents",            :limit => 16777215,                    :null => false
  ...
  add_index "phpbb_forums_old", ["forum_last_post_id"], :name => "forum_lastpost_id"
  add_index "phpbb_forums_old", ["left_id", "right_id"], :name => "left_right_id"
  ...
  create_table "phpbb_gym_config", :primary_key => "config_name", :force => true do |t|
    t.string "config_value",               :default => "",    :null => false
    t.string "config_type",  :limit => 10, :default => "gym", :null => false
  end

  add_index "phpbb_gym_config", ["config_type"], :name => "config_type"
  ...
  create_table "phpbb_mods", :primary_key => "mod_id", :force => true do |t|
    ...
    t.string  "mod_name",         :limit => 100,      :default => "",    :null => false
  ...
  create_table "phpbb_netinocensored", :id => false, :force => true do |t|
    ...
    t.text    "msg_vu",                                                   :null => false
    t.text    "commentaires_modo",                                        :null => false
    t.string  "send_cheksum",      :limit => 32,       :default => "_",   :null => false
    t.boolean "tphm",                                  :default => false
    t.string  "post_attribute",    :limit => 25
  end
  ...
  create_table "phpbb_posts", :primary_key => "post_id", :force => true do |t|
    ...
    t.integer "post_edit_count",   :limit => 2,        :default => 0,     :null => false
    t.boolean "post_edit_locked",                      :default => false, :null => false
    t.string  "msg_vu",            :limit => 5,        :default => "_",   :null => false
    t.string  "commentaires_modo", :limit => 25,       :default => "_",   :null => false
    t.string  "send_cheksum",      :limit => 32,       :default => "_",   :null => false
    t.boolean "tphm",                                  :default => false
    t.string  "post_attribute",    :limit => 25
  end
  ...
  add_index "phpbb_posts", ["post_username"], :name => "post_username"
  ...
  create_table "phpbb_privmsgs", :primary_key => "msg_id", :force => true do |t|
    ...
    t.boolean "forum_options",                           :default => false, :null => false
  ...
  create_table "phpbb_profile_fields_data", :primary_key => "user_id", :force => true do |t|
    t.integer "pf_modedereception", :limit => 3
    t.integer "pf_decodeur",        :limit => 3
  end
  ...
  create_table "phpbb_prs_modpoints", :id => false, :force => true do |t|
    t.integer "time",                 :default => 0, :null => false
    t.integer "user_id", :limit => 3, :default => 0, :null => false
    t.integer "post_id", :limit => 3, :default => 0, :null => false
    t.integer "points",  :limit => 1, :default => 0, :null => false
  end

  add_index "phpbb_prs_modpoints", ["post_id"], :name => "post_id"

  create_table "phpbb_prs_penalty", :id => false, :force => true do |t|
    t.integer "user_id",   :limit => 3, :default => 0, :null => false
    t.integer "poster_id", :limit => 3, :default => 0, :null => false
    t.integer "penalty",   :limit => 1, :default => 0, :null => false
  end

  create_table "phpbb_prs_votes", :id => false, :force => true do |t|
    t.integer "user_id",            :limit => 3,  :default => 0,     :null => false
    t.string  "user_ip",            :limit => 40, :default => "",    :null => false
    t.integer "post_id",            :limit => 3,  :default => 0,     :null => false
    t.integer "score",              :limit => 1,  :default => 0,     :null => false
    t.integer "standard_diviation", :limit => 2,  :default => 0,     :null => false
    t.boolean "shadow",                           :default => false, :null => false
    t.integer "time",                             :default => 0,     :null => false
    t.integer "poster_id",          :limit => 3,  :default => 0,     :null => false
  end

  add_index "phpbb_prs_votes", ["post_id"], :name => "post_id"

  create_table "phpbb_prs_votes_chi", :id => false, :force => true do |t|
    t.integer "user1_id", :limit => 3, :default => 0, :null => false
    t.integer "user2_id", :limit => 3, :default => 0, :null => false
    t.integer "time",                  :default => 0, :null => false
    t.integer "chi",      :limit => 1, :default => 0, :null => false
    t.integer "diff",     :limit => 1, :default => 0, :null => false
    t.integer "num",      :limit => 1, :default => 0, :null => false
  end

  add_index "phpbb_prs_votes_chi", ["time", "num"], :name => "time"
  ...
  create_table "phpbb_reports", :primary_key => "report_id", :force => true do |t|
    ...
    t.string  "rpt_vu",        :limit => 3,        :default => "_",   :null => false
  ...
  add_index "phpbb_search_wordmatch", ["word_id", "post_id"], :name => "sfr_idx_01"
  ...
  add_index "phpbb_sessions", ["session_forum_id"], :name => "session_fid"
  ...
  create_table "phpbb_topics", :primary_key => "topic_id", :force => true do |t|
    ...
    t.string  "topic_attribute",           :limit => 25
    t.boolean "sorttop"
    t.integer "is_moved",                  :limit => 1,  :default => 0,     :null => false
    t.string  "topic_url",                               :default => "",    :null => false
  end
  ...
  add_index "phpbb_topics", ["topic_last_post_id"], :name => "topic_lpid"
  add_index "phpbb_topics", ["topic_last_post_time"], :name => "last_post_time"
  add_index "phpbb_topics", ["topic_title"], :name => "topic_title"

  create_table "phpbb_topics_attr", :primary_key => "attr_id", :force => true do |t|
    t.boolean "attr_type",                      :default => false, :null => false
    t.string  "attr_name",                      :default => "",    :null => false
    t.integer "left_id",          :limit => 3,  :default => 0,     :null => false
    t.integer "right_id",         :limit => 3,  :default => 0,     :null => false
    t.string  "attr_img",                       :default => "",    :null => false
    t.string  "attr_date",        :limit => 25
    t.string  "attr_colour",      :limit => 6,  :default => "",    :null => false
    t.boolean "attr_user_colour",               :default => false, :null => false
  end

  create_table "phpbb_topics_moves", :id => false, :force => true do |t|
    t.integer "topic_id", :null => false
    t.integer "forum_id", :null => false
  end

  add_index "phpbb_topics_moves", ["topic_id", "forum_id"], :name => "topic_id"
  ...
  create_table "phpbb_topicscensored", :id => false, :force => true do |t|
    t.integer "topic_id",                  :limit => 3,   :default => 0,     :null => false
    t.integer "forum_id",                  :limit => 3,   :default => 0,     :null => false
    t.integer "icon_id",                   :limit => 3,   :default => 0,     :null => false
    t.boolean "topic_attachment",                         :default => false, :null => false
  ...
  create_table "phpbb_user_group", :force => true do |t|
    t.integer "group_id",     :limit => 3, :default => 0,     :null => false
    t.integer "user_id",      :limit => 8, :default => 0,     :null => false
  ...
  create_table "phpbb_users", :primary_key => "user_id", :force => true do |t|
    ...
    t.string  "user_abonne",              :limit => 16,                                                              :null => false
    ...
    t.integer "user_rank2",               :limit => 3,                                      :default => 0,           :null => false
    t.integer "user_rank3",               :limit => 3,                                      :default => 0,           :null => false
